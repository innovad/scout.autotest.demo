 ...
 */
public class AutotestServerTestApplication implements IApplication {

  private static final String PERFORM_TESTS_AND_EXIT_ARG_NAME = "performTestsAndExit";

  @Override
  public Object start(IApplicationContext context) throws Exception {
    // this session is used for backend-services and also for webservices
    // final ServerSession session = SERVICES.getService(IServerSessionRegistryService.class).newServerSession(ServerSession.class, Activator.getDefault().getBackendSubject(), UserAgent.createDefault());
