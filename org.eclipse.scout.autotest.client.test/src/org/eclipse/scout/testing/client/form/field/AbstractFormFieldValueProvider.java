...
public abstract class AbstractFormFieldValueProvider implements IFormFieldValueProvider {
  ...
  public void fillValueField(IValueField<?> field, Object value) {
    if (field != null && field.isEnabled() && FormTestUtility.isFieldVisible(field)) {
      if (field instanceof IBooleanField) {
        ...
        fillDoubleField((IDoubleField) field, value);
      }
  ...
  private void fillDoubleField(IDoubleField field, Object value) {
  ...
  private <T> void fillListBox(IListBox<T> field, Object value) {
    ...
    field.setValue(typedListBoxValue);
  }
  ...
  private <T> void fillTreeBox(ITreeBox<T> field, Object value) {
    ...
    field.setValue(typedTreeBoxValue);
  }
  ...
  protected abstract Double getDefaultDoubleValue(IDoubleField field);
  ...
  protected Object[] getDefaultListBoxValue(IListBox<?> field) {
    ...
    ITableRow[] rows = activeColumn.findRows(true);
    ...
    return keyColumn.getValues(enabledRows.toArray((ITableRow[]) Array.newInstance(ITableRow.class, enabledRows.size())));
  }
